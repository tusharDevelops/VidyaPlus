...
export default function ConfirmationModal({modalData}) {
  return ReactDOM.createPortal(
    <div className="fixed inset-0 z-[10000] !mt-0 grid place-items-center overflow-auto bg-slate-900/60 backdrop-blur-md transition-all duration-300">
      <div className="w-11/12 max-w-[400px] rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-8 shadow-2xl shadow-indigo-500/10 scale-in-center overflow-hidden">
