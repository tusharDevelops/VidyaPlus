           ...
           <details key={index} open className="group transition-all duration-500 bg-white dark:bg-slate-800/40 rounded-2xl border border-slate-100 dark:border-slate-700 overflow-hidden shadow-sm hover:shadow-xl hover:shadow-indigo-600/5 transition-all">
              ...
              <div className="px-5 pb-5 pt-2 space-y-3 bg-slate-50/50 dark:bg-slate-900/20 border-t border-slate-50 dark:border-slate-800/50 animate-in slide-in-from-top-4 duration-500">
                ...
                <div className="space-y-3">
                  {section.subSection.map((data) => (
                    ...
                    >
                      ...
                      >
                        <button
                          className="w-7 h-7 flex items-center justify-center rounded-md text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-all"
                          onClick={() =>
                        ...
                        <button
                          className="w-7 h-7 flex items-center justify-center rounded-md text-slate-400 hover:text-red-500 transition-all"
                          onClick={() =>
                            setConfirmationModal({
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-x-2 px-4 py-3 rounded-xl border-2 border-dashed border-indigo-200 dark:border-indigo-800/50 text-indigo-600 dark:text-indigo-400 font-bold text-xs uppercase tracking-widest hover:bg-indigo-600 hover:text-white dark:hover:bg-indigo-600 dark:hover:text-white hover:border-transparent transition-all duration-500 mt-4"
                >
