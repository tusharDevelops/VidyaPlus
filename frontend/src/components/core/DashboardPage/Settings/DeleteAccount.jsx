...
export default function DeleteAccount() {
  ...
  return (
    <>
    <div className="my-10 flex flex-col sm:flex-row gap-8 rounded-hero border border-red-200/50 dark:border-red-900/30 bg-red-50/50 dark:bg-red-950/10 p-10 px-8 shadow-sm transition-all duration-500 group relative overflow-hidden">
        <div className="flex aspect-square h-20 w-20 items-center justify-center rounded-3xl bg-red-100 dark:bg-red-900/40 border border-red-200 dark:border-red-800 shadow-sm group-hover:scale-110 transition-transform duration-500">
        ...
        <div className="flex flex-col space-y-4 relative z-10">
          ...
          <button
            ...
            className={`w-fit cursor-pointer mt-4 px-10 py-4 rounded-full text-xs font-black uppercase tracking-widest transition-all duration-300
              ${confirmation === CONFIRM_TEXT 
                ? "bg-red-600 text-white hover:bg-red-700 hover:scale-105 active:scale-95 shadow-sm" 
