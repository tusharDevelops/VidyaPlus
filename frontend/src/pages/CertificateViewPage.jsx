      ...
      <div className="relative overflow-hidden bg-white p-16 text-center shadow-2xl certificate-layout w-full max-w-[1000px] aspect-[1.414/1] flex flex-col justify-between">
        ...
        <div className="relative z-20 pt-4 flex flex-col items-center">
          <div className="flex flex-col items-center mb-2">
             <span className="text-[2.5rem] font-black text-[#111111] font-sans z-10 relative" style={{ letterSpacing: '-0.02em', fontFamily: 'Inter, sans-serif' }}>
                Vidya<span className="text-[#ff4a1c]">+</span>
             </span>
             <img src={logo} alt="VidyaPlus Feather" className="h-14 object-contain drop-shadow-md z-0 relative -mt-6" />
          </div>
