...
const ContactUsPage = () => {
  return (
    <div className="bg-white dark:bg-slate-950 transition-colors duration-500 min-h-screen relative overflow-hidden">
      ...
      <div className="mx-auto pt-32 pb-32 flex w-11/12 max-w-maxContent flex-col justify-between gap-8 lg:flex-row relative z-10">
        {/* Contact Details */}
        ...
        {/* Contact Form */}
        <div className="lg:w-[55%] bg-white dark:bg-slate-900/40 p-10 md:p-8 rounded-[3rem] shadow-2xl shadow-indigo-500/5 border border-slate-200 dark:border-slate-800 backdrop-blur-xl relative group">
          <div className="absolute top-0 left-0 w-20 h-20 bg-indigo-600/5 rounded-full -ml-16 -mt-16 transition-transform group-hover:scale-150 duration-700"></div>
          <div className="relative z-10">
             <div className="mb-10">
               ...
               <h2 className="text-2xl font-black text-slate-900 dark:text-white tracking-tight">Establish Communication</h2>
